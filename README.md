...
Compile: Open a terminal or command prompt and navigate to the directory where you saved main.cpp. Use your C++ compiler to compile the code.
...
Execute: After successful compilation, run the executable:
Bash
...
Usage
Getting Started
Register: On the main menu, click "Register" to create a new user account.
Login: Use your registered credentials or the admin/admin123 credentials to log in.
User Functions
